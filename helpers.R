...
get_db <- function() {
    ...
    db_data <- readRDS("db_athma_2017_09_01.data")
    ...
    #db <- dbConnect(RSQLite::SQLite(), "/home/numa/Documents/Projects/data/metaxcan/results/result_db/metaxcan_results_athma.db")
    return(db)
}
